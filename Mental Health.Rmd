...
## Boosted Trees
Below we see that the misclassification error rate for the model is .256 and the AUC is about .82. We also see the plot of MR against number of layers and see how it decreases slightly after 15 layers.
